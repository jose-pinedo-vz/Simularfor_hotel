...
class Habitaciones:
    def __init__(self):
        ...
        tabla_llegadas = [["Llegadas", "Prob", "Acum", "Rango"],
                          [0, 0.29, 0.29, "0 - 0.29"],
                          [1, 0.30, 0.59, "0.2901 - 0.59"],
                          [2, 0.20, 0.79, "0.5901 - 0.79"],
                          [3, 0.21, 1, "0.7901 - 1"]]
        ...
        tabla_tipo = [["Tipo", "Prob", "Acum", "Rango"],
        ...
        tabla_estancia = [["Noches", "Prob", "Acum", "Rango"],

...
class Prueba_Del_Poker():
    def Ventana(self,lista):
        ...
        lb_2=ctk.CTkLabel(self.VentanaPoker, 
                          ...
                          font=("Arial", 15))
        lb_2.place(relx=.25, rely=.2, anchor=ctk.CENTER)
        ...
        btn.place(relx=.25,rely=.25,anchor=ctk.CENTER)
    ...
    def Prueba(self,aleatorios,porc):
        ...
        lb_prob=ctk.CTkLabel(self.VentanaPoker, 
                          ...
                          ,font=("Arial", 15))
        lb_prob.place(relx=.25, rely=.8, anchor=ctk.CENTER)
    ...
    def AjustaTamaño(self,aleatorios,l):
        box_ajuste=ctk.CTkTextbox(self.VentanaPoker,width=250,height=300,font=("Consolas", 12))
        box_ajuste.place(relx=.25,rely=.5,anchor=ctk.CENTER)
    ...
    def Aceptacion(self,X0,porc):
        ...
        if X0<ji2:
            ...
            lb_rechazado=ctk.CTkLabel(self.VentanaPoker, 
                          text=f"ji2: {ji2}\tX0: {X0}"

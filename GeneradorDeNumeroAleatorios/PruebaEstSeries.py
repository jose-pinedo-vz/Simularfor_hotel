...
from GeneradorDeNumeroAleatorios.ArchivosTXT import AbrirArchivo
...
class Prueba_Series():
    def Ventana(self,lista):
        ...
        lb_1=ctk.CTkLabel(self.VentanaSeries, 
                          ...
                          "\n(se recomienda n>2)",
                          font=("Arial", 15))
        lb_1.place(relx=.2, rely=.15, anchor=ctk.CENTER)

        self.entry_N=ctk.CTkEntry(self.VentanaSeries,placeholder_text="n")
        self.entry_N.place(relx=.2, rely=.2, anchor=ctk.CENTER)
        ...
        lb_2=ctk.CTkLabel(self.VentanaSeries, 
                          ...
                          "\n(ejemplo 5%)",
                          font=("Arial", 15))
        lb_2.place(relx=.2, rely=.25, anchor=ctk.CENTER)

        self.entry_P=ctk.CTkEntry(self.VentanaSeries,placeholder_text="%")
        self.entry_P.place(relx=.2, rely=.3, anchor=ctk.CENTER)

        self.box_matriz=ctk.CTkTextbox(self.VentanaSeries,width=300,height=400,font=("Consolas", 12))
        self.box_matriz.place(relx=.2,rely=.7,anchor=ctk.CENTER)
